...
void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  xarm_msgs__srv__RobotiqGetStatus_Event__init(message_memory);
}

void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_fini_function(void * message_memory)
{
  xarm_msgs__srv__RobotiqGetStatus_Event__fini(message_memory);
}

size_t xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__size_function__RobotiqGetStatus_Event__request(
  const void * untyped_member)
{
  const xarm_msgs__srv__RobotiqGetStatus_Request__Sequence * member =
    (const xarm_msgs__srv__RobotiqGetStatus_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__request(
  const void * untyped_member, size_t index)
{
  const xarm_msgs__srv__RobotiqGetStatus_Request__Sequence * member =
    (const xarm_msgs__srv__RobotiqGetStatus_Request__Sequence *)(untyped_member);
...
void * xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__request(
  void * untyped_member, size_t index)
{
  xarm_msgs__srv__RobotiqGetStatus_Request__Sequence * member =
    (xarm_msgs__srv__RobotiqGetStatus_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__fetch_function__RobotiqGetStatus_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const xarm_msgs__srv__RobotiqGetStatus_Request * item =
    ((const xarm_msgs__srv__RobotiqGetStatus_Request *)
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__request(untyped_member, index));
  xarm_msgs__srv__RobotiqGetStatus_Request * value =
    (xarm_msgs__srv__RobotiqGetStatus_Request *)(untyped_value);
  *value = *item;
}

void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__assign_function__RobotiqGetStatus_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  xarm_msgs__srv__RobotiqGetStatus_Request * item =
    ((xarm_msgs__srv__RobotiqGetStatus_Request *)
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__request(untyped_member, index));
  const xarm_msgs__srv__RobotiqGetStatus_Request * value =
    (const xarm_msgs__srv__RobotiqGetStatus_Request *)(untyped_value);
  *item = *value;
}

bool xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__resize_function__RobotiqGetStatus_Event__request(
  void * untyped_member, size_t size)
{
  xarm_msgs__srv__RobotiqGetStatus_Request__Sequence * member =
    (xarm_msgs__srv__RobotiqGetStatus_Request__Sequence *)(untyped_member);
  xarm_msgs__srv__RobotiqGetStatus_Request__Sequence__fini(member);
  return xarm_msgs__srv__RobotiqGetStatus_Request__Sequence__init(member, size);
}

size_t xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__size_function__RobotiqGetStatus_Event__response(
  const void * untyped_member)
{
  const xarm_msgs__srv__RobotiqGetStatus_Response__Sequence * member =
    (const xarm_msgs__srv__RobotiqGetStatus_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__response(
  const void * untyped_member, size_t index)
{
  const xarm_msgs__srv__RobotiqGetStatus_Response__Sequence * member =
    (const xarm_msgs__srv__RobotiqGetStatus_Response__Sequence *)(untyped_member);
...
void * xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__response(
  void * untyped_member, size_t index)
{
  xarm_msgs__srv__RobotiqGetStatus_Response__Sequence * member =
    (xarm_msgs__srv__RobotiqGetStatus_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__fetch_function__RobotiqGetStatus_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const xarm_msgs__srv__RobotiqGetStatus_Response * item =
    ((const xarm_msgs__srv__RobotiqGetStatus_Response *)
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__response(untyped_member, index));
  xarm_msgs__srv__RobotiqGetStatus_Response * value =
    (xarm_msgs__srv__RobotiqGetStatus_Response *)(untyped_value);
  *value = *item;
}

void xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__assign_function__RobotiqGetStatus_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  xarm_msgs__srv__RobotiqGetStatus_Response * item =
    ((xarm_msgs__srv__RobotiqGetStatus_Response *)
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__response(untyped_member, index));
  const xarm_msgs__srv__RobotiqGetStatus_Response * value =
    (const xarm_msgs__srv__RobotiqGetStatus_Response *)(untyped_value);
  *item = *value;
}

bool xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__resize_function__RobotiqGetStatus_Event__response(
  void * untyped_member, size_t size)
{
  xarm_msgs__srv__RobotiqGetStatus_Response__Sequence * member =
    (xarm_msgs__srv__RobotiqGetStatus_Response__Sequence *)(untyped_member);
  xarm_msgs__srv__RobotiqGetStatus_Response__Sequence__fini(member);
  return xarm_msgs__srv__RobotiqGetStatus_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs__srv__RobotiqGetStatus_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(xarm_msgs__srv__RobotiqGetStatus_Event, request),  // bytes offset in struct
    NULL,  // default value
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__size_function__RobotiqGetStatus_Event__request,  // size() function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__request,  // get_const(index) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__request,  // get(index) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__fetch_function__RobotiqGetStatus_Event__request,  // fetch(index, &value) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__assign_function__RobotiqGetStatus_Event__request,  // assign(index, value) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__resize_function__RobotiqGetStatus_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(xarm_msgs__srv__RobotiqGetStatus_Event, response),  // bytes offset in struct
    NULL,  // default value
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__size_function__RobotiqGetStatus_Event__response,  // size() function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_const_function__RobotiqGetStatus_Event__response,  // get_const(index) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__get_function__RobotiqGetStatus_Event__response,  // get(index) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__fetch_function__RobotiqGetStatus_Event__response,  // fetch(index, &value) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__assign_function__RobotiqGetStatus_Event__response,  // assign(index, value) function pointer
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__resize_function__RobotiqGetStatus_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_members = {
  "xarm_msgs__srv",  // message namespace
  "RobotiqGetStatus_Event",  // message name
  3,  // number of fields
  sizeof(xarm_msgs__srv__RobotiqGetStatus_Event),
  false,  // has_any_key_member_
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_member_array,  // message members
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_type_support_handle = {
  0,
  &xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_xarm_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Event)() {
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Request)();
  xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Response)();
  if (!xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_type_support_handle.typesupport_identifier) {
    xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t xarm_msgs__srv__detail__robotiq_get_status__rosidl_typesupport_introspection_c__RobotiqGetStatus_service_type_support_handle = {
  ...
  &xarm_msgs__srv__RobotiqGetStatus_Request__rosidl_typesupport_introspection_c__RobotiqGetStatus_Request_message_type_support_handle,
  &xarm_msgs__srv__RobotiqGetStatus_Response__rosidl_typesupport_introspection_c__RobotiqGetStatus_Response_message_type_support_handle,
  &xarm_msgs__srv__RobotiqGetStatus_Event__rosidl_typesupport_introspection_c__RobotiqGetStatus_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_xarm_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, RobotiqGetStatus_Event)()->data;
  }
