...
class Metaclass_SetAnalogIO_Event(type):
    """Metaclass of message 'SetAnalogIO_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_analog_io__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_analog_io__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_analog_io__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_analog_io__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_analog_io__event
...
class SetAnalogIO_Event(metaclass=Metaclass_SetAnalogIO_Event):
    """Message class 'SetAnalogIO_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<xarm_msgs/SetAnalogIO_Request, 1>',
        'response': 'sequence<xarm_msgs/SetAnalogIO_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'SetAnalogIO_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'SetAnalogIO_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from xarm_msgs.srv import SetAnalogIO_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogIO_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogIO_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from xarm_msgs.srv import SetAnalogIO_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogIO_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogIO_Response'"
...
class Metaclass_SetAnalogIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_analog_io.Metaclass_SetAnalogIO_Event._TYPE_SUPPORT is None:
                _set_analog_io.Metaclass_SetAnalogIO_Event.__import_type_support__()
...
class SetAnalogIO(metaclass=Metaclass_SetAnalogIO):
    ...
    from xarm_msgs.srv._set_analog_io import SetAnalogIO_Event as Event
