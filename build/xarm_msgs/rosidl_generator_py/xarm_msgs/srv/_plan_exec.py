...
class Metaclass_PlanExec_Event(type):
    """Metaclass of message 'PlanExec_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__plan_exec__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__plan_exec__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__plan_exec__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__plan_exec__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__plan_exec__event
...
class PlanExec_Event(metaclass=Metaclass_PlanExec_Event):
    """Message class 'PlanExec_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<xarm_msgs/PlanExec_Request, 1>',
        'response': 'sequence<xarm_msgs/PlanExec_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'PlanExec_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'PlanExec_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from xarm_msgs.srv import PlanExec_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, PlanExec_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'PlanExec_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from xarm_msgs.srv import PlanExec_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PlanExec_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'PlanExec_Response'"
...
class Metaclass_PlanExec(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _plan_exec.Metaclass_PlanExec_Event._TYPE_SUPPORT is None:
                _plan_exec.Metaclass_PlanExec_Event.__import_type_support__()
...
class PlanExec(metaclass=Metaclass_PlanExec):
    ...
    from xarm_msgs.srv._plan_exec import PlanExec_Event as Event
