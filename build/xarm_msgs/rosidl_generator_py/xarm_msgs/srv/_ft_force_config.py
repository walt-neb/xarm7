...
class Metaclass_FtForceConfig_Event(type):
    """Metaclass of message 'FtForceConfig_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__ft_force_config__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__ft_force_config__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__ft_force_config__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__ft_force_config__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__ft_force_config__event
...
class FtForceConfig_Event(metaclass=Metaclass_FtForceConfig_Event):
    """Message class 'FtForceConfig_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<xarm_msgs/FtForceConfig_Request, 1>',
        'response': 'sequence<xarm_msgs/FtForceConfig_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'FtForceConfig_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['xarm_msgs', 'srv'], 'FtForceConfig_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from xarm_msgs.srv import FtForceConfig_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FtForceConfig_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FtForceConfig_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from xarm_msgs.srv import FtForceConfig_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FtForceConfig_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FtForceConfig_Response'"
...
class Metaclass_FtForceConfig(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _ft_force_config.Metaclass_FtForceConfig_Event._TYPE_SUPPORT is None:
                _ft_force_config.Metaclass_FtForceConfig_Event.__import_type_support__()
...
class FtForceConfig(metaclass=Metaclass_FtForceConfig):
    ...
    from xarm_msgs.srv._ft_force_config import FtForceConfig_Event as Event
