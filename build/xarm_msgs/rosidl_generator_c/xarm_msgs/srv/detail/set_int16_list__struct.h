...
enum
{
  xarm_msgs__srv__SetInt16List_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xarm_msgs__srv__SetInt16List_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetInt16List in the package xarm_msgs.
typedef struct xarm_msgs__srv__SetInt16List_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xarm_msgs__srv__SetInt16List_Request__Sequence request;
  xarm_msgs__srv__SetInt16List_Response__Sequence response;
} xarm_msgs__srv__SetInt16List_Event;

// Struct for a sequence of xarm_msgs__srv__SetInt16List_Event.
typedef struct xarm_msgs__srv__SetInt16List_Event__Sequence
{
