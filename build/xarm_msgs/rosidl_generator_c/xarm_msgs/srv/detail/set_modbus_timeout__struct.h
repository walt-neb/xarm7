...
enum
{
  xarm_msgs__srv__SetModbusTimeout_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xarm_msgs__srv__SetModbusTimeout_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetModbusTimeout in the package xarm_msgs.
typedef struct xarm_msgs__srv__SetModbusTimeout_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xarm_msgs__srv__SetModbusTimeout_Request__Sequence request;
  xarm_msgs__srv__SetModbusTimeout_Response__Sequence response;
} xarm_msgs__srv__SetModbusTimeout_Event;

// Struct for a sequence of xarm_msgs__srv__SetModbusTimeout_Event.
typedef struct xarm_msgs__srv__SetModbusTimeout_Event__Sequence
{
