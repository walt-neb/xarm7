...
enum
{
  xarm_msgs__srv__GetSetModbusData_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xarm_msgs__srv__GetSetModbusData_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetSetModbusData in the package xarm_msgs.
typedef struct xarm_msgs__srv__GetSetModbusData_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xarm_msgs__srv__GetSetModbusData_Request__Sequence request;
  xarm_msgs__srv__GetSetModbusData_Response__Sequence response;
} xarm_msgs__srv__GetSetModbusData_Event;

// Struct for a sequence of xarm_msgs__srv__GetSetModbusData_Event.
typedef struct xarm_msgs__srv__GetSetModbusData_Event__Sequence
{
