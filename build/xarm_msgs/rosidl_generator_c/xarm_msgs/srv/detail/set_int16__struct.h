...
enum
{
  xarm_msgs__srv__SetInt16_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xarm_msgs__srv__SetInt16_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetInt16 in the package xarm_msgs.
typedef struct xarm_msgs__srv__SetInt16_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xarm_msgs__srv__SetInt16_Request__Sequence request;
  xarm_msgs__srv__SetInt16_Response__Sequence response;
} xarm_msgs__srv__SetInt16_Event;

// Struct for a sequence of xarm_msgs__srv__SetInt16_Event.
typedef struct xarm_msgs__srv__SetInt16_Event__Sequence
{
