...
void SetFloat32_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) xarm_msgs::srv::SetFloat32_Event(_init);
}

void SetFloat32_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xarm_msgs::srv::SetFloat32_Event *>(message_memory);
  typed_message->~SetFloat32_Event();
}

size_t size_function__SetFloat32_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<xarm_msgs::srv::SetFloat32_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<xarm_msgs::srv::SetFloat32_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<xarm_msgs::srv::SetFloat32_Request> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const xarm_msgs::srv::SetFloat32_Request *>(
    get_const_function__SetFloat32_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<xarm_msgs::srv::SetFloat32_Request *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<xarm_msgs::srv::SetFloat32_Request *>(
    get_function__SetFloat32_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const xarm_msgs::srv::SetFloat32_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<xarm_msgs::srv::SetFloat32_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<xarm_msgs::srv::SetFloat32_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<xarm_msgs::srv::SetFloat32_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__SetFloat32_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const xarm_msgs::srv::SetFloat32_Response *>(
    get_const_function__SetFloat32_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<xarm_msgs::srv::SetFloat32_Response *>(untyped_value);
  value = item;
}
...
void assign_function__SetFloat32_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<xarm_msgs::srv::SetFloat32_Response *>(
    get_function__SetFloat32_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const xarm_msgs::srv::SetFloat32_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetFloat32_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(xarm_msgs::srv::SetFloat32_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xarm_msgs::srv::SetFloat32_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(xarm_msgs::srv::SetFloat32_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xarm_msgs::srv::SetFloat32_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(xarm_msgs::srv::SetFloat32_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetFloat32_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(xarm_msgs::srv::SetFloat32_Event),
  false,  // has_any_key_member_
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, SetFloat32_Event)() {
  return &::xarm_msgs::srv::rosidl_typesupport_introspection_cpp::SetFloat32_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetFloat32_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xarm_msgs::srv::SetFloat32_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xarm_msgs::srv::SetFloat32_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<xarm_msgs::srv::SetFloat32_Event>(),
...
get_service_type_support_handle<xarm_msgs::srv::SetFloat32>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::xarm_msgs::srv::SetFloat32_Event
      >()->data
      );
  }
