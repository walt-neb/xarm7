...
class Init_FtImpedance_Event_response
{
public:
  explicit Init_FtImpedance_Event_response(::xarm_msgs::srv::FtImpedance_Event & msg)
  : msg_(msg)
  {}
  ::xarm_msgs::srv::FtImpedance_Event response(::xarm_msgs::srv::FtImpedance_Event::_response_type arg)
  {
...
private:
  ::xarm_msgs::srv::FtImpedance_Event msg_;
};

class Init_FtImpedance_Event_request
{
public:
  explicit Init_FtImpedance_Event_request(::xarm_msgs::srv::FtImpedance_Event & msg)
  : msg_(msg)
  {}
  Init_FtImpedance_Event_response request(::xarm_msgs::srv::FtImpedance_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_FtImpedance_Event_response(msg_);
  }
...
class Init_FtImpedance_Event_info
{
public:
  Init_FtImpedance_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FtImpedance_Event_request info(::xarm_msgs::srv::FtImpedance_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_FtImpedance_Event_request(msg_);
  }
...
template<>
inline
auto build<::xarm_msgs::srv::FtImpedance_Event>()
{
  return xarm_msgs::srv::builder::Init_FtImpedance_Event_info();
}
