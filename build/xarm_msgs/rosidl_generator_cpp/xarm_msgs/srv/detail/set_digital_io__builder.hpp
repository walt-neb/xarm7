...
{
public:
  explicit Init_SetDigitalIO_Event_response(::xarm_msgs::srv::SetDigitalIO_Event & msg)
  : msg_(msg)
  {}
  ::xarm_msgs::srv::SetDigitalIO_Event response(::xarm_msgs::srv::SetDigitalIO_Event::_response_type arg)
  {
...
private:
  ::xarm_msgs::srv::SetDigitalIO_Event msg_;
};

class Init_SetDigitalIO_Event_request
{
public:
  explicit Init_SetDigitalIO_Event_request(::xarm_msgs::srv::SetDigitalIO_Event & msg)
  : msg_(msg)
  {}
  Init_SetDigitalIO_Event_response request(::xarm_msgs::srv::SetDigitalIO_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetDigitalIO_Event_request info(::xarm_msgs::srv::SetDigitalIO_Event::_info_type arg)
  {
...
template<>
inline
auto build<::xarm_msgs::srv::SetDigitalIO_Event>()
{
  return xarm_msgs::srv::builder::Init_SetDigitalIO_Event_info();
}
