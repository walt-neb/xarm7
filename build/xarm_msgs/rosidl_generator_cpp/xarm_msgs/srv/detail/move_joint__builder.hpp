...
class Init_MoveJoint_Event_response
{
public:
  explicit Init_MoveJoint_Event_response(::xarm_msgs::srv::MoveJoint_Event & msg)
  : msg_(msg)
  {}
  ::xarm_msgs::srv::MoveJoint_Event response(::xarm_msgs::srv::MoveJoint_Event::_response_type arg)
  {
...
private:
  ::xarm_msgs::srv::MoveJoint_Event msg_;
};

class Init_MoveJoint_Event_request
{
public:
  explicit Init_MoveJoint_Event_request(::xarm_msgs::srv::MoveJoint_Event & msg)
  : msg_(msg)
  {}
  Init_MoveJoint_Event_response request(::xarm_msgs::srv::MoveJoint_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_MoveJoint_Event_response(msg_);
  }
...
class Init_MoveJoint_Event_info
{
public:
  Init_MoveJoint_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_MoveJoint_Event_request info(::xarm_msgs::srv::MoveJoint_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_MoveJoint_Event_request(msg_);
  }
...
template<>
inline
auto build<::xarm_msgs::srv::MoveJoint_Event>()
{
  return xarm_msgs::srv::builder::Init_MoveJoint_Event_info();
}
