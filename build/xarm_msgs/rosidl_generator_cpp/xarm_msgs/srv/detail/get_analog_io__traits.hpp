...
inline std::string to_yaml(const GetAnalogIO_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use xarm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const xarm_msgs::srv::GetAnalogIO_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  xarm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use xarm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const xarm_msgs::srv::GetAnalogIO_Event & msg)
{
  return xarm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<xarm_msgs::srv::GetAnalogIO_Event>()
{
  return "xarm_msgs::srv::GetAnalogIO_Event";
}

template<>
inline const char * name<xarm_msgs::srv::GetAnalogIO_Event>()
{
  return "xarm_msgs/srv/GetAnalogIO_Event";
}

template<>
struct has_fixed_size<xarm_msgs::srv::GetAnalogIO_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<xarm_msgs::srv::GetAnalogIO_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<xarm_msgs::srv::GetAnalogIO_Request>::value && has_bounded_size<xarm_msgs::srv::GetAnalogIO_Response>::value> {};

template<>
struct is_message<xarm_msgs::srv::GetAnalogIO_Event>
  : std::true_type {};
