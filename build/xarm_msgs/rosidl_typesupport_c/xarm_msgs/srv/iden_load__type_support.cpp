...
static const _IdenLoad_Event_type_support_symbol_names_t _IdenLoad_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, IdenLoad_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, IdenLoad_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, IdenLoad_Event)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::IdenLoad_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t IdenLoad_service_type_support_handle = {
  ...
  &IdenLoad_Request_message_type_support_handle,
  &IdenLoad_Response_message_type_support_handle,
  &IdenLoad_Event_message_type_support_handle,
