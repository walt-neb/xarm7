...
static const _TrajCtrl_Event_type_support_symbol_names_t _TrajCtrl_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, TrajCtrl_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, TrajCtrl_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, TrajCtrl_Event)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::TrajCtrl_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TrajCtrl_service_type_support_handle = {
  ...
  &TrajCtrl_Request_message_type_support_handle,
  &TrajCtrl_Response_message_type_support_handle,
  &TrajCtrl_Event_message_type_support_handle,
