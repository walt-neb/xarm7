...
static const _TrajPlay_Event_type_support_symbol_names_t _TrajPlay_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, TrajPlay_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, TrajPlay_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, TrajPlay_Event)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::TrajPlay_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t TrajPlay_service_type_support_handle = {
  ...
  &TrajPlay_Request_message_type_support_handle,
  &TrajPlay_Response_message_type_support_handle,
  &TrajPlay_Event_message_type_support_handle,
