...
typedef struct _FtImpedance_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _FtImpedance_Event_type_support_ids_t;

static const _FtImpedance_Event_type_support_ids_t _FtImpedance_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _FtImpedance_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _FtImpedance_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _FtImpedance_Event_type_support_symbol_names_t _FtImpedance_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, FtImpedance_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtImpedance_Event)),
  }
};

typedef struct _FtImpedance_Event_type_support_data_t
{
  void * data[2];
} _FtImpedance_Event_type_support_data_t;

static _FtImpedance_Event_type_support_data_t _FtImpedance_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _FtImpedance_Event_message_typesupport_map = {
  2,
  "xarm_msgs",
  &_FtImpedance_Event_message_typesupport_ids.typesupport_identifier[0],
  &_FtImpedance_Event_message_typesupport_symbol_names.symbol_name[0],
  &_FtImpedance_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t FtImpedance_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_FtImpedance_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, FtImpedance_Event)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::FtImpedance_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t FtImpedance_service_type_support_handle = {
  ...
  &FtImpedance_Request_message_type_support_handle,
  &FtImpedance_Response_message_type_support_handle,
  &FtImpedance_Event_message_type_support_handle,
