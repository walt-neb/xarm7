...
static const _PlanExec_Event_type_support_symbol_names_t _PlanExec_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, PlanExec_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, PlanExec_Event)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::PlanExec_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, PlanExec_Event)() {
  return get_message_type_support_handle<xarm_msgs::srv::PlanExec_Event>();
}
...
static const rosidl_service_type_support_t PlanExec_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::PlanExec_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::PlanExec_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::PlanExec_Event>(),
