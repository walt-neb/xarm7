...
static const _BioGripperCtrl_Event_type_support_symbol_names_t _BioGripperCtrl_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, BioGripperCtrl_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, BioGripperCtrl_Event)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::BioGripperCtrl_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, BioGripperCtrl_Event)() {
  return get_message_type_support_handle<xarm_msgs::srv::BioGripperCtrl_Event>();
}
...
static const rosidl_service_type_support_t BioGripperCtrl_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::BioGripperCtrl_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::BioGripperCtrl_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::BioGripperCtrl_Event>(),
